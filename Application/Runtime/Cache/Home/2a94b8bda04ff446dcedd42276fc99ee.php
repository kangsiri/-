...
<div class="banner">
	<div class="wrapper">
		<div class="left">
<!--&lt;!&ndash;			<ul>&ndash;&gt;-->
<!--&lt;!&ndash;				<li><a href="#">前端开发<span>></span></a></li>&ndash;&gt;-->
<!--&lt;!&ndash;				<li><a href="#">视频剪辑<span>></span></a></li>&ndash;&gt;-->
<!--&lt;!&ndash;				<li><a href="#">Javascript<span>></span></a></li>&ndash;&gt;-->
<!--&lt;!&ndash;				<li><a href="#">Python<span>></span></a></li>&ndash;&gt;-->
<!--&lt;!&ndash;				<li><a href="#">.Vue<span>></span></a></li>&ndash;&gt;-->
<!--&lt;!&ndash;				<li><a href="#">Javascript<span>></span></a></li>&ndash;&gt;-->
<!--&lt;!&ndash;				<li><a href="#">Mysql<span>></span></a></li>&ndash;&gt;-->
<!--&lt;!&ndash;				<li><a href="#">Android<span>></span></a></li>&ndash;&gt;-->
<!--&lt;!&ndash;			</ul>&ndash;&gt;-->
<!--			-->
			<div id="slide">
				<?php if(is_array($cate)): $i = 0; $__LIST__ = array_slice($cate,0,9,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i;?><div class="cate">
					<div class="cate1 "><a href="/dyk/Home/Index/find/cid/<?php echo ($v1["cid"]); ?>"><?php echo ($v1["cname"]); ?></a></div>
					<div class="subitem" style="display:none;">
						<?php if(isset($v1["child"])): if(is_array($v1["child"])): $i = 0; $__LIST__ = array_slice($v1["child"],0,7,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($i % 2 );++$i;?><dl><dt><a href="/dyk/Home/Index/find/cid/<?php echo ($v2["cid"]); ?>"><?php echo ($v2["cname"]); ?></a></dt><dd>
								<?php if(isset($v2["child"])): if(is_array($v2["child"])): $i = 0; $__LIST__ = array_slice($v2["child"],0,5,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v3): $mod = ($i % 2 );++$i;?>|<a href="/dyk/Home/Index/find/cid/<?php echo ($v3["cid"]); ?>"><?php echo ($v3["cname"]); ?></a><?php endforeach; endif; else: echo "" ;endif; endif; ?></dd>
...
<div class="box wrapper">
	...
	<div class="content clearfix">
		<ul>
			<li>
				<a href="goods.html">
					<img src="/dyk/Public/image/course011.png" alt="">
			...
			<li>
				<a href="#">
					<img src="/dyk/Public/image/course02.png" alt="">
			...
			<li>
				<a href="#">
					<img src="/dyk/Public/image/course03.png" alt="">
			...
			<li>
				<a href="#">
					<img src="/dyk/Public/image/course04.png" alt="">
			...
			<li>
				<a href="#">
					<img src="/dyk/Public/image/course05.png" alt="">
			...
			<li>
				<a href="#">
					<img src="/dyk/Public/image/course06.png" alt="">
			...
			<li>
				<a href="#">
					<img src="/dyk/Public/image/course07.png" alt="">
					<h3>UNITY<br>入门</h3>
			...
			<li>
				<a href="#">
					<img src="/dyk/Public/image/course08.png" alt="">
					<h3>Cocos<br><br></h3>
...
<div id="best">
	...
	<?php if(is_array($best)): foreach($best as $key=>$v): ?><ul class="item left">
		<li><a href="/dyk/Home/Index/goods/id/<?php echo ($v["gid"]); ?>" target="_blank"><?php if(empty($v["thumb"])): ?><img src="/dyk/Public/image/preview.jpg"><?php else: ?><img src="/dyk/Public/uploads/thumb/<?php echo ($v["thumb"]); ?>"><?php endif; ?></a></li>
		<li class="goods"><a href="/dyk/Home/Index/goods/id/<?php echo ($v["gid"]); ?>" target="_blank"><?php echo ($v["gname"]); ?></a></li>
